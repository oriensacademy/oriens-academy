-- ============================================================================
-- UPDATE CLEANUP RPC WITH WHERE CLAUSE FOR NOTIFICATION PURGE
-- Migration: 20260827151000_update_cleanup_rpc_where_clause.sql
-- ============================================================================
...
begin
  ...
  -- 2. Delete Notifications (with WHERE clause for safe-update compliance)
