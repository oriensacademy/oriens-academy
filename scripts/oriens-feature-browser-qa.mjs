...
check((await page.getByRole("radio").count()) === 15, "TR assessment does not list all 15 public exams");
...
await page.waitForTimeout(1200);
check((await page.getByRole("radio").count()) === 15, "EN assessment does not list all 15 public exams");
