...
export const studentCopy = {
  tr: {
    ...
    tabs: ["Genel Bakış", "Profilim", "Randevularım", "Derslerim", "Ödevlerim", "Paketim", "Ödemelerim", "Sınav Geçmişi", "Destek"],
  },
  en: {
    ...
    tabs: ["Overview", "Profile", "Appointments", "Lessons", "Homework", "My Package", "Payments", "Exam History", "Support"],
  },
} as const;
