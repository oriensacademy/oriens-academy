...
export const studentCopy = {
  tr: {
    ...
    fullName: "Ad Soyad",
    phone: "Telefon",
    school: "Okul (isteğe bağlı)",
    targetExam: "Hedef Sınav (isteğe bağlı)",
    targetCountry: "Hedef Ülke (isteğe bağlı)",
    ...
    accountCreated: "Hesabınız oluşturuldu ve oturumunuz açıldı.",
  ...
  en: {
    ...
    targetExam: "Target Exam (optional)",
    targetCountry: "Target Country (optional)",
    loginAction: "Log In",
    registerAction: "Create Account",
    noAccount: "No account yet?",
    hasAccount: "Already have an account?",
    registrationReceived: "Your registration has been received. Check your email to verify your account.",
    accountCreated: "Your account has been created and you are signed in.",
