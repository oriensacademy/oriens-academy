...
const PREDEFINED_QUALIFICATIONS: PredefinedEntity[] = [
  ...
  { name: "SAT", code: "SAT", type: "QUALIFICATION", aliases: ["sat", "digital sat", "sats", "sat test", "sat exam", "sat reasoning", "sat sinavi"] },
  ...
  { name: "Test of Academic Reasoning for Admissions", code: "TARA", type: "QUALIFICATION", aliases: ["tara", "test of academic reasoning for admissions", "academic reasoning admissions test"] },
  ...
  { name: "GMAT Exam", code: "GMAT", type: "QUALIFICATION", aliases: ["gmat", "gmat focus", "graduate management admission test", "gmat focus edition"] },
  { name: "Online Mathematics Placement Test", code: "OMPT", type: "QUALIFICATION", aliases: ["ompt", "ompt-a", "ompt-b", "ompt-c", "ompt-d", "ompt-e", "ompt-f", "online math placement test", "hollanda matematik sinavi"] },
