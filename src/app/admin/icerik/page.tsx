...
type ContentTab = "content" | "questions" | "assignments" | "submissions" | "testimonials";
...
export default function AdminContentPage() {
  ...
  const tabs: Array<{ id: ContentTab; label: string; icon: typeof ClipboardList }> = [
    ...
    { id: "testimonials", label: "Öğrenci Yorumları", icon: MessageSquareQuote },
  ];
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight text-ink font-heading">
                İçerik & Materyal Yönetimi
              </h1>
              <p className="text-xs text-muted-foreground">
                Ödev, ders notu, çalışma kağıdı, soru kütüphanesi ve kaynak materyalleri tek merkezden yönetin.
              </p>
            </div>
          </div>
        </div>
